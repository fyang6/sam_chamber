...
NAMELIST /PARAMETERS/ dodamping, doupperbound, docloud, doprecip, &
		...
		fluxt0,fluxq0,tau0,tabs_s,tabs_w,tabs_t,z0,nelapse, dt, dx, dy,  &
		...
		nsave3D, nsave3Dstart, nsave3Dend, nsave3D_micro, dosfcforcing, &
		...
		CEM,LES,OCEAN,LAND,SFC_FLX_FXD,SFC_TAU_FXD, soil_wetness, &
                CNS_FLX,dowallsflux,dowallmflux, &
...
!            this for detector
                ndet_rtd, ndet_sonicu, ndet_sonicv, ndet_sonicw, &
                ndet_licor, ndet_thermistors, ndet_virtual, pdet, idet, ndetout
