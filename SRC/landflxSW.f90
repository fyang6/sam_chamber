...
psiq1(x,x0)=2.*log((1.+x*x)/(1.+x0*x0))
...
psiq2(xsi,xsiq0,xq0) = log(xsiq/xsiq0)-psiq1(xq,xq0)+0.8*((-xsi)**0.3333-(-xsiq)**0.3333)
! stable: 0 < xsi < 1
psim3(xsi,xsim0) = -5.*(xsi-xsim0)
psih3(xsi,xsih0) = -5.*(xsi-xsih0)
psiq3(xsi,xsiq0) = -5.*(xsi-xsiq0)
! very stable: 0 < xsi < 1
psim4(xsi,xsim0) = log(xsi**5/xsim0)+5.*(1.-xsim0)+xsi-1.
psih4(xsi,xsih0) = log(xsi**5/xsih0)+5.*(1.-xsih0)+xsi-1.
psiq4(xsi,xsiq0) = log(xsi**5/xsiq0)+5.*(1.-xsiq0)+xsi-1.
...
z0h=z0/h
z0t = z0*0.619 ! roughness length for temperature
z0q = z0*0.756 ! roughness length for moisture
zTh=z0t/h
zQh=z0q/h
zodym = log(1./z0h)
zodyh = log(1./zTh)
