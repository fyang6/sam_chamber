...
integer:: ncycle_max = 32  ! maximum number of subcycling within dt
!integer:: ncycle_max = 8  ! maximum number of subcycling within dt
...
logical :: dos_b = .true.  ! flag to calculate bottom surface scalar flux
logical :: dos_t = .true.  ! flag to calculate top surface scalar flux
logical :: dos_n = .true.  ! flag to calculate north surface scalar flux
logical :: dos_s = .true.  ! flag to calculate south surface scalar flux
logical :: dos_w = .true.  ! flag to calculate west surface scalar flux
logical :: dos_e = .true.  ! flag to calculate east surface scalar flux

real(8):: tabs_s =0.	! surface temperature at bot,K
real(8):: tabs_w =0.	! wall temperature,K
real(8):: tabs_t =0.	! surface temperature at top,K

real(8) :: ts_b = 0.  ! bottom surface temperature, K
real(8) :: ts_t = 0.  ! top surface temperature, K
real(8) :: ts_n = 0.  ! north surface temperature, K
real(8) :: ts_s = 0.  ! south surface temperature, K
real(8) :: ts_w = 0.  ! west surface temperature, K
real(8) :: ts_e = 0.  ! east surface temperature, K
...
real::   z0     =0.00075	! roughness length
!real::   z0     =0.01	! roughness length
real::   soil_wetness =0.0 ! wetness coeff for soil (from 0 to 1.)

real :: soil_b = 1.0 ! wetness coeff for bottom surface (from 0 to 1.)
real :: soil_t = 1.0 ! wetness coeff for top surface (from 0 to 1.)
real :: soil_n = 1.0 ! wetness coeff for north surface (from 0 to 1.)
real :: soil_s = 1.0 ! wetness coeff for south surface (from 0 to 1.)
real :: soil_w = 1.0 ! wetness coeff for west surface (from 0 to 1.)
real :: soil_e = 1.0 ! wetness coeff for east surface (from 0 to 1.)
...
logical:: cns_flx = .false. ! flag indicating that the flux is constant or not
...
logical:: dowallsflux = .false.
logical:: dowallmflux = .false.
...
! for detector
integer :: ndet_rtd = 8
integer :: ndet_sonicu = 2
integer :: ndet_sonicv = 2
integer :: ndet_sonicw = 2
integer :: ndet_licor = 2
integer :: ndet_thermistors = 2
