...
module domain
       ...
       integer, parameter :: nx_gl = 48 ! Number of grid points in X
       integer, parameter :: ny_gl = 48 ! Number of grid points in Y
       integer, parameter :: nz_gl = 144 ! Number of pressure (scalar) levels
       integer, parameter :: nsubdomains_x  = 4 ! =4 No of subdomains in x
